...
class Character {
  ...
  drawFallingTo(direction) {
    if (direction === "left") {
      ...
      push()
      translate(this.x - 3, this.y - 47)
      rotate(50)
      rect(0, 0, 8, 16, 5)
      pop()
      rect(this.x - 14, this.y - 40, 8, 15, 5);
      ...
      // Right arm
      push()
      translate(this.x + 13, this.y - 62)
      rotate(-60)
      ellipse(0, 0, 7, 20)
      pop()
      rect(this.x + 9, this.y - 40, 8, 15, 5);

      push()
      translate(this.x + 20, this.y - 59)
      rotate(-85)
      ellipse(0, 0, 7, 15)
      pop()
